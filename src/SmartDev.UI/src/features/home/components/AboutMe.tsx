  ...
  return (
    <AppPageContainer contentClassName="grid md:grid-cols-4" id="about-me" sectionClassName="scroll-mt-32">
      <div className="flex flex-col gap-8 md:col-span-3">
        <h1 className="text-3xl font-bold uppercase leading-tight sm:text-4xl md:text-5xl">About Me</h1>
        <img src={meImage} className="mx-auto block w-1/2 rounded-full border border-border shadow-lg md:hidden" alt="Franco Diaz Licham" />
        <p>
      ...
      <div className="hidden content-center md:col-span-1 md:block">
        <img src={meImage} className="w-full rounded-full border border-border shadow-lg" alt="Franco Diaz Licham" />
      </div>
    </AppPageContainer>
  );
};
