...
- Worker Flex Consumption service plan: `ASP-SmartDevApp-91b9`
- Worker Function App: `smartdevapp-worker-af`
- Function deployment storage account: `smartdevappsa`
- API deployment package container
- Worker deployment package container
...
terraform import azurerm_storage_container.worker_deployment_package https://smartdevappsa.blob.core.windows.net/app-package-smartdevapp-worker-af-62d2b21
...
terraform import azurerm_service_plan.worker /subscriptions/<your-subscription-id>/resourceGroups/SmartDevApp/providers/Microsoft.Web/serverfarms/ASP-SmartDevApp-91b9
...
terraform import azurerm_function_app_flex_consumption.worker /subscriptions/<your-subscription-id>/resourceGroups/SmartDevApp/providers/Microsoft.Web/sites/smartdevapp-worker-af
```
...
Function App settings are intentionally not managed in this starter Terraform setup because they often contain secrets.
