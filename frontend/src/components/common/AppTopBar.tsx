...
export const AppTopBar = () => {
  ...
  const visibleNavigationItems = navigationItems.filter((item) => item.visibility === 'always' || (isAuthReady && (item.visibility === 'authenticated' ? isAuthenticated : !isAuthenticated)));
