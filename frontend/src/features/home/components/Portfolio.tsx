...
export const Portfolio = () => {
  return (
    <section id="portfolio" className="mx-auto max-w-[1320px] scroll-mt-32 px-4 py-16">
          ...
          <section key={group.title}>
            ...
            <div className="flex flex-wrap justify-center gap-12">
              {group.items.map((item) => (
                <article className="w-full max-w-[540px] overflow-hidden bg-card shadow-[0_10px_15px_rgb(160_160_160_/_0.75)] transition hover:cursor-pointer hover:bg-accent/40 max-sm:max-w-[340px]" key={item.title}>
