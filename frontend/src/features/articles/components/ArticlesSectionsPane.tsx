import type { ArticleSectionModel } from '../utils/articleContent';

interface ArticlesSectionsPaneProps {
...
export const ArticlesSectionsPane = ({ sections }: ArticlesSectionsPaneProps) => (
  <aside className="hidden min-h-0 overflow-y-auto p-6 xl:block xl:border-r">
    <h2 className="border-b border-border pb-4 text-lg font-extrabold">Table of Content</h2>
