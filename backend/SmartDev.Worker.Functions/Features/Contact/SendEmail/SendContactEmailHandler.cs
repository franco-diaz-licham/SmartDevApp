...
namespace SmartDev.Worker.Functions.Features.Contact.SendEmail;
    ...
    ILogger<SendContactEmailHandler> logger)
{
    ...
    private const string ContactEmailTemplateResourceName = "SmartDev.Worker.Functions.Features.Contact.SendEmail.ContactEmail.html";
